...
namespace UıLayer
{
    public partial class ListelemeForm : Form
    {
        ...
        private void ListelemeForm_Load(object sender, EventArgs e)
        {
            ...
            cbTumPersonel.Checked = true; // Form açıldığında tüm personel seçili olsun
            ListeleOkutmalar();           // Açılışta liste dolsun
        ...
        {
            // Rapor tipi değişince işlem yapılmak istenirse buraya yazılır
        }
